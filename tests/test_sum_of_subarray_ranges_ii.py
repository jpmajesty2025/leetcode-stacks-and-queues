...
from sum_of_subarray_ranges import sum_subarray_ranges as brute_force_sum_subarray_ranges
from sum_of_subarray_ranges_ii import sum_subarray_ranges
...
def test_sum_subarray_ranges_matches_original_solution_oracle(nums: list[int]) -> None:
    assert sum_subarray_ranges(nums) == brute_force_sum_subarray_ranges(nums)
