...
from number_of_valid_subarrays import valid_subarrays as brute_force_valid_subarrays
from number_of_valid_subarrays_ii import valid_subarrays
...
def test_valid_subarrays_matches_original_solution_oracle(nums: list[int]) -> None:
